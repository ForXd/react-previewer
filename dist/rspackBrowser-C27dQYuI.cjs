...
const require_constant = require("./constant-BxxoVZEr.cjs");
...
async function compileRspackBrowserProject(input, options = {}, rspackBrowserModule) {
	...
	const transformer = new require_constant.CodeTransformer();
...
//# sourceMappingURL=rspackBrowser-C27dQYuI.cjs.map