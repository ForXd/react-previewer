import { C as _defineProperty, d as resolveDependencyUrl, f as transformDepsToEsmLinks, n as DEFAULT_DEPENDENCIES, r as TRANSFORM_OPTIONS, s as injectJSXSourceInfoAndCssImports, u as parsePackagePath } from "./constant-BaNPjeT9.js";
...
function createProjectFiles(files, sourceAttributeNames, depsInfo) {
	...
	for (const [fileName, content] of Object.entries(files)) projectFiles[toProjectPath(fileName)] = isJSXSourceFile(fileName) ? injectJSXSourceInfoAndCssImports(content, {
		filename: fileName,
		files,
		depsInfo,
...
function replaceExternalImportSpecifiers(outputText, dependencies) {
	const replaceSpecifier = (specifier) => resolveDependencyUrl(specifier, dependencies, TRANSFORM_OPTIONS) ?? specifier;
...
//# sourceMappingURL=rspackBrowser-D4bcWV9R.js.map