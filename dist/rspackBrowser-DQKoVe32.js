import { n as DEFAULT_DEPENDENCIES, o as transformDepsToEsmLinks, r as TRANSFORM_OPTIONS, u as injectJSXSourceInfo, x as _defineProperty } from "./constant-CBGOutKk.js";
...
function createProjectFiles(files, sourceAttributeNames) {
	...
	for (const [fileName, content] of Object.entries(files)) projectFiles[toProjectPath(fileName)] = isJSXSourceFile(fileName) ? injectJSXSourceInfo(content, {
		filename: fileName,
		files,
...
//# sourceMappingURL=rspackBrowser-DQKoVe32.js.map