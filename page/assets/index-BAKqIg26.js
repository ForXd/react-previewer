  ...
  return (
    <BrowserRouter>
...
}`,"deps.json":`{"react-router-dom":"6.30.1"}`},entryFile:`App.tsx`}}).map(([e,t])=>({key:e,...t})),Ee=a(`Example`),De=[{value:`babel`,label:`Babel`},{value:`rspack-browser`,label:`Rspack`}],Oe=()=>{let[e,t]=(0,y.useState)(Te[0]),[n,r]=(0,y.useState)(!1),[i,a]=(0,y.useState)(null),[o,s]=(0,y.useState)(!1),[c,l]=(0,y.useState)(`babel`),[u,d]=(0,y.useState)({}),[f,p]=(0,y.useState)({enabled:!0,level:2,showTimestamp:!1}),m=(0,y.useRef)(null),h=(0,y.useMemo)(()=>{let t={...e.files};return`deps.json`in t&&delete t[`deps.json`],t},[e]),g=(0,y.useCallback)(()=>h,[h]),_=(0,y.useMemo)(()=>{try{let t=e.files[`deps.json`];return t?JSON.parse(t):{}}catch(e){return Ee.error(`Parse deps.json error:`,e),{}}},[e]);(0,y.useEffect)(()=>{d(g())},[g]);let v=e=>{Ee.debug(`Element clicked in example:`,e),a(e)},b=()=>{Ee.debug(`Closing source tooltip from example`),a(null)},x=(0,y.useCallback)((e,t)=>{d(n=>({...n,[e]:t}))},[]),S=(0,y.useCallback)(()=>{d(g())},[g]);(0,y.useEffect)(()=>{let e=e=>{i&&!e.defaultPrevented&&(Ee.debug(`Closing source info due to outside click`),a(null))};if(i)return document.addEventListener(`click`,e),()=>document.removeEventListener(`click`,e)},[i]);let C=(0,y.useMemo)(()=>{let t=o?u:g();return Ee.debug(`getCurrentFiles called:`,{editingMode:o,selectedDemo:e.key,filesKeys:Object.keys(t),filesHash:JSON.stringify(Object.keys(t).sort())}),t},[o,u,g,e.key]),w=(0,y.useMemo)(()=>c===`rspack-browser`?{type:`rspack-browser`,rspack:{cdnDomain:`https://esm.sh`}}:`babel`,[c]);return(0,A.jsxs)(`div`,{ref:m,className:`flex h-screen w-full bg-white text-[#171717]`,children:[(0,A.jsxs)(`div`,{className:`
      ...
      `,children:[(0,A.jsxs)(`div`,{className:`flex items-center justify-between border-b border-[#ebebeb] p-4`,children:[!n&&(0,A.jsxs)(`div`,{children:[(0,A.jsx)(`h2`,{className:`text-base font-semibold text-[#171717]`,children:`React Previewer`}),(0,A.jsx)(`p`,{className:`mt-1 text-xs text-[#666666]`,children:`组件示例与实时预览`})]}),(0,A.jsx)(`button`,{onClick:()=>r(!n),className:`rounded-md p-2 text-[#666666] transition-colors hover:bg-[#fafafa] hover:text-[#171717]`,title:n?`展开侧边栏`:`收起侧边栏`,children:(0,A.jsx)(`svg`,{className:`h-5 w-5 transition-transform ${n?`rotate-180`:``}`,fill:`none`,stroke:`currentColor`,viewBox:`0 0 24 24`,children:(0,A.jsx)(`path`,{strokeLinecap:`round`,strokeLinejoin:`round`,strokeWidth:2,d:`M15 19l-7-7 7-7`})})})]}),(0,A.jsx)(`div`,{className:`flex-1 overflow-y-auto p-3`,children:n?(0,A.jsx)(`div`,{className:`space-y-2`,children:Te.map((n,r)=>(0,A.jsx)(`button`,{onClick:()=>t(n),className:`
                  ...
                  `,children:[(0,A.jsx)(`div`,{className:`mb-1 text-sm font-semibold`,children:n.name}),(0,A.jsx)(`div`,{className:`text-xs leading-relaxed opacity-75`,children:n.description})]},n.key))})}),!n&&(0,A.jsxs)(`div`,{className:`border-t border-[#ebebeb] bg-[#fafafa] p-4`,children:[(0,A.jsx)(`h3`,{className:`mb-3 text-sm font-semibold text-[#171717]`,children:`日志配置`}),(0,A.jsxs)(`div`,{className:`space-y-2`,children:[(0,A.jsxs)(`label`,{className:`flex items-center`,children:[(0,A.jsx)(`input`,{type:`checkbox`,checked:f.enabled,onChange:e=>p(t=>({...t,enabled:e.target.checked})),className:`mr-2 accent-[#171717]`}),(0,A.jsx)(`span`,{className:`text-xs text-[#4d4d4d]`,children:`启用日志`})]}),(0,A.jsxs)(`div`,{children:[(0,A.jsx)(`label`,{className:`mb-1 block text-xs text-[#4d4d4d]`,children:`日志级别`}),(0,A.jsxs)(`select`,{value:f.level,onChange:e=>p(t=>({...t,level:parseInt(e.target.value)})),className:`w-full rounded-md bg-white px-2 py-1 text-xs text-[#171717] shadow-[0_0_0_1px_#ebebeb]`,children:[(0,A.jsx)(`option`,{value:0,children:`ERROR`}),(0,A.jsx)(`option`,{value:1,children:`WARN`}),(0,A.jsx)(`option`,{value:2,children:`INFO`}),(0,A.jsx)(`option`,{value:3,children:`DEBUG`}),(0,A.jsx)(`option`,{value:4,children:`TRACE`})]})]}),(0,A.jsxs)(`label`,{className:`flex items-center`,children:[(0,A.jsx)(`input`,{type:`checkbox`,checked:f.showTimestamp,onChange:e=>p(t=>({...t,showTimestamp:e.target.checked})),className:`mr-2 accent-[#171717]`}),(0,A.jsx)(`span`,{className:`text-xs text-[#4d4d4d]`,children:`显示时间戳`})]})]})]})]}),(0,A.jsxs)(`div`,{className:`flex min-w-0 flex-1 flex-col`,children:[(0,A.jsx)(`div`,{className:`border-b border-[#ebebeb] bg-white px-6 py-4`,children:(0,A.jsxs)(`div`,{className:`flex flex-wrap items-center justify-between gap-4`,children:[(0,A.jsxs)(`div`,{className:`min-w-0`,children:[(0,A.jsxs)(`div`,{className:`mb-2 flex flex-wrap items-center gap-2`,children:[(0,A.jsx)(`span`,{className:`rounded-full bg-[#ebf5ff] px-2.5 py-1 text-xs font-medium text-[#0068d6]`,children:`Demo`}),(0,A.jsx)(`span`,{className:`rounded-full bg-[#fafafa] px-2.5 py-1 font-mono text-xs font-medium text-[#666666] shadow-[0_0_0_1px_#ebebeb]`,children:e.entryFile})]}),(0,A.jsx)(`h1`,{className:`text-xl font-semibold text-[#171717]`,children:e.name}),(0,A.jsx)(`p`,{className:`mt-1 text-sm text-[#666666]`,children:e.description})]}),(0,A.jsxs)(`div`,{className:`flex items-center gap-3`,children:[(0,A.jsx)(`div`,{className:`flex h-9 items-center rounded-md bg-[#fafafa] p-0.5 shadow-[0_0_0_1px_#ebebeb]`,children:De.map(e=>(0,A.jsx)(`button`,{type:`button`,onClick:()=>l(e.value),title:`${e.label} 编译预览`,className:`
                      h-8 min-w-20 rounded px-3 text-xs font-medium transition-colors
                      ${c===e.value?`bg-white text-[#171717] shadow-[0_0_0_1px_rgba(0,0,0,0.08)]`:`text-[#666666] hover:text-[#171717]`}
                    `,children:e.label},e.value))}),(0,A.jsx)(`button`,{onClick:()=>s(!o),className:`
                  rounded-md px-4 py-2 text-sm font-medium transition-colors
                  ${o?`bg-[#0068d6] text-white hover:bg-[#005ac0]`:`bg-[#171717] text-white hover:bg-black`}
                `,children:o?`退出编辑`:`实时编辑`}),o&&(0,A.jsx)(`button`,{onClick:S,className:`rounded-md bg-white px-4 py-2 text-sm font-medium text-[#4d4d4d] shadow-[0_0_0_1px_#ebebeb] transition-colors hover:bg-[#fafafa] hover:text-[#171717]`,children:`重置`})]})]})}),(0,A.jsxs)(`div`,{className:`flex min-h-0 flex-1`,children:[o&&(0,A.jsxs)(`div`,{className:`w-1/2 overflow-y-auto border-r border-[#ebebeb] bg-white p-4`,children:[(0,A.jsx)(`h3`,{className:`mb-4 text-base font-semibold text-[#171717]`,children:`文件编辑`}),(0,A.jsx)(`div`,{className:`space-y-4`,children:Object.entries(C).map(([e,t])=>(0,A.jsxs)(`div`,{children:[(0,A.jsx)(`h4`,{className:`mb-2 font-mono text-sm font-medium text-[#4d4d4d]`,children:e}),(0,A.jsx)(`textarea`,{value:t,onChange:t=>x(e,t.target.value),className:`h-32 w-full resize-none rounded-md bg-[#fafafa] p-3 font-mono text-xs text-[#171717] shadow-[0_0_0_1px_#ebebeb] transition focus:bg-white`,placeholder:`输入代码...`})]},e))})]}),(0,A.jsx)(`div`,{className:`${o?`w-1/2`:`w-full`} relative min-w-0`,children:(0,A.jsx)(`div`,{className:`absolute inset-0`,children:(Ee.debug(`Rendering ReactPreviewer:`,{selectedDemo:e.key,files:Object.keys(C),deps:Object.keys(_),entryFile:e.entryFile}),(0,A.jsx)(xe,{files:C,depsInfo:_,entryFile:e.entryFile,onElementClick:v,loggerConfig:f,compiler:w}))})})]}),(e.key===`simpleReactDemo`||e.key===`dependencyLoadingDemo`||e.key===`arcoDesignDemo`||e.key===`antdDesignDemo`)&&(0,A.jsxs)(`div`,{className:`border-t border-[#ebebeb] bg-white px-6 py-4`,children:[(0,A.jsx)(`h3`,{className:`mb-2 text-sm font-semibold text-[#171717]`,children:`依赖加载功能说明`}),(0,A.jsxs)(`div`,{className:`space-y-1 text-xs text-[#666666]`,children:[(0,A.jsx)(`p`,{children:(0,A.jsx)(`strong`,{children:`观察要点:`})}),(0,A.jsxs)(`ul`,{className:`list-disc list-inside space-y-1 ml-2`,children:[(0,A.jsx)(`li`,{children:`页面加载时应该显示依赖加载进度条`}),(0,A.jsx)(`li`,{children:`进度条显示每个依赖的加载状态（等待中、加载中、已加载、加载失败）`}),(0,A.jsx)(`li`,{children:`加载完成后进度条自动消失`}),(0,A.jsx)(`li`,{children:`如果依赖加载失败，会显示错误状态`})]}),(0,A.jsxs)(`p`,{className:`mt-2`,children:[(0,A.jsx)(`strong`,{children:`当前依赖:`}),` `,Object.keys(_).length>0?Object.keys(_).join(`, `):`无外部依赖`]})]})]})]}),i&&(0,A.jsx)(we,{sourceInfo:i,containerElement:m.current||document.body,onClose:b})]})};function ke(){return(0,A.jsx)(A.Fragment,{children:(0,A.jsx)(Oe,{})})}(0,b.createRoot)(document.getElementById(`root`)).render((0,A.jsx)(y.StrictMode,{children:(0,A.jsx)(ke,{})}));